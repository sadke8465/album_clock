/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2eadf6f18d0fc0257038ee95e0bd39c5)
...
interface __BaseEnv_Env {
	...
	USER_AGENT: "album-matrix-clock/2.0 (+https://github.com/sadke8465/album_clock)";
	LAST_FM_API_KEY: string;
	NOW_PLAYING: DurableObjectNamespace<import("./src/index").NowPlayingCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NowPlayingCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LAST_FM_USER" | "ROTATION_SECONDS" | "USER_AGENT" | "LAST_FM_API_KEY">> {}
}
declare module "*.csv" {
	const value: string;
